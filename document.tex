...
\newcommand{\documentTitle}{Microcontroller Based Vehicle Anti Collision Monitoring System} % put tilde (~) between words to indicate non-breaking adjacent words

...
\newcommand{\documentAdviserTitle}{Mr.} 
\newcommand{\documentAdviser}{Melvin K. Cabatuan}

\newcommand{\examinerChairTitle}{Ms.} 
\newcommand{\examinerChair}{Donabel D. Abuan}

% Sort in alphabetically ascending manner the surnames of the examiners
\newcommand{\examinerATitle}{Mr.} 
\newcommand{\examinerA}{Reggie C. Gustilo}

\newcommand{\examinerBTitle}{Mr.} 
...
\defineAuthor{surname1}{Chan}
\defineAuthor{firstname1}{Zion Eric O.}

\defineAuthor{surname2}{Comendador}
\defineAuthor{firstname2}{Glenn Rommel P.}

\defineAuthor{surname3}{Garcia}
\defineAuthor{firstname3}{Laureen Audrey R.}

\defineAuthor{surname4}{Fallar}
\defineAuthor{firstname4}{Mac Excel S.}

\defineAuthor{surname5}{Lerit}
\defineAuthor{firstname5}{Jose Mari Luis L.}

\newcommand{\documentTitle}{Home Power Management System using GSM with Electricity Billing Display with Bill SMS feature} % put tilde (~) between words to indicate non-breaking adjacent words
